...
# assuming the southern section of the reservoir can't be accessed.

# Read polygon shapefile
eqArea188 <- st_read(dsn = "../../../lakeDsn/CIN/CH4-188",
                             layer = "eqArea188")  # shapefile name
...
# clean up attributes
eqArea188 <- eqArea188 %>%
  mutate(lakeName = "Stubblefield Reservoir",
         lakeSiteID = "ch4-188") %>%
...
# ch4_188_All.png works, but ch4_188_AllSites.png does not.
...
mapview::mapshot(m, file = "../../../lakeDsn/CIN/CH4-188/188_All.png", 
...
mapview::mapshot(m, file = "../../../lakeDsn/CIN/CH4-188/188_Main.png", 
                 remove_controls = NULL)
...
mapview::mapshot(m, file = "../../../lakeDsn/CIN/CH4-188/188_Over.png", 
                 remove_controls = NULL)
...
write.table(sitesWGS188 %>%
            ...
            file = "../../../lakeDsn/CIN/CH4-188/ch4_188Sites.txt",
            row.names = FALSE, sep="\t")
...
st_write(obj = sitesMerc188, 
         dsn = file.path( "../../../lakeDsn/CIN/CH4-188", "merc188.gpkg"), 
         layer = "AllSitesMerc188", # package appends 'main.' to layer name?
...
st_write(obj = sitesMerc188buffer, 
         dsn = file.path( "../../../lakeDsn/CIN/CH4-188", "merc188.gpkg"), 
         layer = "AllSitesMerc188buffer", # package appends 'main.' to layer name?
         append=FALSE, # this overwrites existing layer
         driver = "GPKG")
...
st_write(obj = filter(sitesMerc188buffer, panel == "OverSamp"),
         dsn = file.path( "../../../lakeDsn/CIN/CH4-188", "merc188.gpkg"), 
         layer = "OverSampSitesMerc188buffer",
         append=FALSE, # this overwrites existing layer,
         driver = "GPKG")
...
st_layers(file.path( "../../../lakeDsn/CIN/CH4-188", "merc188.gpkg"))
