...
measured_depths_147 <- st_read(paste0(userPath, "lakeDsn/ADA/CH4-147/JeanNeustadt_bathy/Jean_Neustadt_Collected_Points.shp")) %>%
  janitor::clean_names(.) %>%
...
boundary_147 <- st_read(paste0(userPath, "lakeDsn/ADA/CH4-147/eqArea147.shp")) %>%
  # include `source` to help with troubleshooting.
