...
# apply get_ada_data21, conv_units, & dup_agg21 to Lake Jean Neustadt excel file
anions_2022_146_190 <- get_ada_data(cin.ada.path, "EPAGPA076_146_190_anions.xls") %>%
  conv_units(filename = "EPAGPA076_146_190_anions.xls") %>%
  site_id_22 %>%
  dup_agg %>% # aggregate lab duplicates (optional)
  flag_agg

anions_2022_184_166 <- get_ada_data(cin.ada.path, "EPAGPA076_184_166_anions.xls") %>%
  conv_units(filename = "EPAGPA076_184_166_anions.xls") %>%
  site_id_22 %>%
  dup_agg %>% # aggregate lab duplicates (optional)
  flag_agg

anions_2022_136_100_206 <- get_ada_data(cin.ada.path, "EPAGPA081_136_100_206_anions.xls") %>%
