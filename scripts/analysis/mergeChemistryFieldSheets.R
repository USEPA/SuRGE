...
# Check dimensions
dim(chemistry) # 152, 133 [3/1/2022]
dim(fld_sheet) # 1036, 72 [3/1/2022]

# Check for correspondence among unique identifiers
# 8 lakes in chemistry, but not in field sheets.  These are all
# R10 lakes from 2018.  As of 3/1/2022, these field sheets
...
dim(chem_fld) # 1126, 203 [3/1/2022]
