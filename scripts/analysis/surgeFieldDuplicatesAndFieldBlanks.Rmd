...
Detection limits vary by analyte, analytical method, lab, and possibly by year.  See `Analytical` section of Wiki for details.  Detection limits are read in below.
...
toc.masi %>%
  ...
  relocate(lake_id, OC, mdl, blank, minimum, maximum) %>%
