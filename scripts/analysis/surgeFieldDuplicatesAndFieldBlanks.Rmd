...
name = c("al", "as", "ba", "be", "br", "br", "ca", "cd", "chla", "chla", "cl", "cl", "cr", "cu", "doc", "f", "f", "fe", "k", "li", "mg", "mn", "na", "nh4", "nh4", "nh4", "ni", "no2", "no2", "no2", "no2_3", "no2_3", "no2_3", "no3", "no3", "no3", "op", "p", "pb", "po4", "po4", "s", "sb", "si", "sn", "so4", "so4", "sr", "tn", "tn", "tn", "toc", "toc", "tp", "tp", "tp", "op", "op", "v", "zn") 
mdl = c(4, 4, 1, 5, 0.041, 0.02, 10, 0.3, 9, NA, 0.026, 0.03, 1, 1, 0.102, 0.014, 0.005, 1, 300, 5, 5, 1, 30, 6, 6, 0.00171, 1, 0.019, 0.015, 0.012, 6, 6, 0.01, 0.049, 0.004, 0.01, 0.002, 5, 2, 0.054, 0.015, 3, 3, 20, 1, 0.151, 0.025, 1, 20.9, 25, 0.002, 0.1, 0.102, 8, 5, 0.002, 3, 3, 1, 0.5)
lab = c("CIN", "CIN", "CIN", "CIN", "ADA", "CIN", "CIN", "CIN", "CIN", "NAR", "ADA", "CIN", "CIN", "CIN", "ADA", "ADA", "CIN", "CIN", "CIN", "CIN", "CIN", "CIN", "CIN", "CIN", "CIN", "ADA", "CIN", "ADA", "CIN", "ADA", "CIN", "CIN", "ADA", "ADA", "CIN", "ADA", "ADA", "CIN", "CIN", "ADA", "CIN", "CIN", "CIN", "CIN", "CIN", "ADA", "CIN", "CIN", "CIN", "CIN", "ADA", "CIN", "ADA", "CIN", "CIN", "ADA", "CIN", "CIN", "CIN", "CIN") 
year = c("All", "All", "All", "All", "2021", "2021", "All", "All", "2018", ">= 2020", "2021", "2021", "All", "All", "2021", "2021", "2021", "All", "All", "All", "All", "All", "All", "2018", "2021", "2020", "All", "2021", "2021", "2020", "2018", "2021", "2020", "2021", "2021", "2020", "2020", "All", "All", "2021", "2021", "All", "All", "All", "All", "2021", "2021", "All", "2018", "2021", "2020", "All", "2021", "2018", "2021", "2020", "2018", "2021", "All", "All")
...
d.anions %>% 
  ...
  select(-lab, -year) %>%
  rename(anion = name, blank = min_blank, minimum = min_unknown, maximum = max_unknown) %>%
  relocate(lake_id, anion, blank, minimum, maximum, mdl) %>%
  kableExtra::kbl(booktabs = TRUE, # nice formatting
...
chem18 %>% 
  ...
  relocate(lake_id, nutrient, blank, minimum, maximum) %>%
  kableExtra::kbl(booktabs = TRUE, # nice formatting
...
chem18 %>% ungroup() %>%
  ...
  theme(legend.title = element_blank(),  # remove legend titles
          axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("2018 Nutrients PLACEHOLDER blanks") +
  facet_wrap(~name, scales = "free") +
  theme(legend.position = "bottom")
...
ada.nutrients %>% ungroup() %>%
  ...
  theme(legend.title = element_blank(),  # remove legend titles
          axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Nutrients Ada PLACEHOLDER") +
  facet_wrap(~name, scales = "free") +
  theme(legend.position = "bottom")
...
chem21 %>% ungroup() %>%
  ...
  theme(legend.title = element_blank(),  # remove legend titles
          axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Nutrients AWBERC 20 & 21 PLACEHOLDER") +
  facet_wrap(~name, scales = "free") +
  theme(legend.position = "bottom")
