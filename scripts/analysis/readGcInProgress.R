...
# 101  These have all been inspected and cannot be recovered. See
...
# on Shimadzu and therefore don't have n2, ar, or O2 percent.  Must filter on ppm
# and percent variables.
...
dim(gc_lakeid) # 2524, no empty rows
