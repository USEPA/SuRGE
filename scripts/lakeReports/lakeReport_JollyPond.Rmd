...
# identify lake
lake_id_i <- "16" # leading zero omitted for this particular lake; zero re-added where needed in Section 1

lake_name_i <- "Jolly Pond"
...
gdb_name <- "lakeDsn/RTP/CH4-016/merc016.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc016" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc016" # e.g., "main_mainSitesMerc233"
...
All reservoirs included in this study were previously sampled by the USEPA during the 2017 National Lakes Assessment (2017 NLA). Data from the 2017 NLA can be found at the EPA website. Data for `r lake_name_i` can be found under SITE_ID `r dsn %>% filter(site_id == paste0("CH4-0", lake_id_i)) %>% select(site_id_2) %>% pull(site_id_2)`.
...
# READ DATA--------------
print(select(dsn, site_id, site_id_2))
