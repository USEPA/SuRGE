...
# identify lake
lake_id_i <- "204" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Beaver Creek Upground Reservoir"
...
gdb_name <- "lakeDsn/CIN/CH4-204/merc204.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc204" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc204" # e.g., "main_mainSitesMerc233"
...
# KEEPING HERE, BUT NOT USING.  CHLOROPHYLL SAMPLE LOST
