...
A field sensor is used to measure chlorophyll a, dissolved oxygen, pH, specific conductivity, water temperature, and turbidity near the water surface at a minimum of 10-20 locations within each reservoir.  Water samples are collected from the deepest site for analysis of nutrients and chlorophyll a.    
...
pts <- read_sf(paste0(userPath, gdb_name), 
               layer = sample_layer) %>%
  filter(siteID != "S-01") %>% # inaccesible
  st_transform(4326) 
...
Water temperature, pH, turbidity, and dissolved oxygen were greatest near the river inflow.  This pattern is sometimes observed when the tributary is the primary nutrient source to the water surface.  Elevated nutrients near the tributary can stimulate algal growth, leading to elevated dissolved oxygen, algal turbidity, and pH.  Elevated water temperature can further stimulate algae growth.
