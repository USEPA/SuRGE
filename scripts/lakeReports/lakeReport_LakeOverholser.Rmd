...
# identify lake
lake_id_i <- "167" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Lake Overholser"
...
gdb_name <- "lakeDsn/ADA/CH4-167/merc167.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc167" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc167" # e.g., "main_mainSitesMerc233"
