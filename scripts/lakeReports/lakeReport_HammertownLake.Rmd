...
# identify lake
lake_id_i <- "101" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Hammertown Lake"
...
gdb_name <- "lakeDsn/CIN/CH4-101/merc101.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc101" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc101" # e.g., "main_mainSitesMerc233"
...
# READ DATA--------------
print(index_site)
print(select(chem_fld_i, site_id, sample_depth, site_depth))
