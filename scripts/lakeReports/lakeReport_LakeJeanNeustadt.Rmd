...
# identify lake
lake_id_i <- "147" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Lake Jean Neustadt"
...
gdb_name <- "lakeDsn/ADA/CH4-147/merc147.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc147" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc147" # e.g., "main_mainSitesMerc233"
