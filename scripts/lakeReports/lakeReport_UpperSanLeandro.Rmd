...
# identify lake
lake_id_i <- "291" # If there's 2-digit ID with a leading zero, typically you will retain the zero to match the file name. If it throws an error when knitting, try removing the zero. 

lake_name_i <- "Upper San Leandro"
...
gdb_name <- "lakeDsn/USGS/CH4-291/merc291.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc291" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc291" # e.g., "main_mainSitesMerc233"
