...
pts <- read_sf(paste0(userPath, gdb_name), 
               layer = sample_layer) %>%
  st_transform(4326) %>%
  filter(siteID != "S-09") # inaccesible, not used
...
Water temperature, DO, pH, and turbidity were highest in the northern portion of the reservoir, near the 153rd Ave road crossing. Elevated water temperature near the road crossing may have stimulated algal metabolism, resulting in higher DO, pH, and turbidity (e.g. algal biomass contributing to turbidity.)
