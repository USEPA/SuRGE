...
# identify lake
lake_id_i <- "98" # leading zero omitted for this particular lake; zero re-added where needed in Section 1

lake_name_i <- "Big Mirror Lake"
...
gdb_name <- "lakeDsn/RTP/CH4-098/merc098.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc098" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc098" # e.g., "main_mainSitesMerc233"
...
ylim.sec <- c(min(10), max(32))# manually scale axis for temperatures
