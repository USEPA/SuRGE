...
A field sensor is used to measure chlorophyll a, dissolved oxygen, pH, specific conductivity, and water temperature near the water surface at a minimum of 10 - 20 locations within each reservoir.  Water samples are collected from the deepest site for analysis of nutrients and chlorophyll a.    
...
disturbance_i <- cbind(depth_prf_mean, nutrients) %>% # join nutrients and 0-2m sonde data
  ...
  mutate(concentration = case_when(parameter == "do" ~ format(concentration, digits = 0, nsmall = 0),
                                   ...
                                   parameter == "chlorophyll a" ~ format(concentration, digits = 2, nsmall = 1)))
...
Water temperature and dissolved oxygen varied little across the reservoir, but were greatest on the eastern side of the lake, near the main inflow.  pH ranged from 8.3 to 8.7, but showed no consistent spatial pattern.
