...
# identify lake
lake_id_i <- "205" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Rosser Park Lake"
...
gdb_name <- "lakeDsn/CIN/CH4-205/merc205.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc205" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc205" # e.g., "main_mainSitesMerc233"
