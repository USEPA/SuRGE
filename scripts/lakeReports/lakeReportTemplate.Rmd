...
# identify lake
lake_id_i <- "233" # If there's 2-digit ID with a leading zero, typically you will retain the zero to match the file name. If it throws an error when knitting, try removing the zero. 
...
# will have to search for folder that contains the string lake_name_i
