...
# identify lake
lake_id_i <- "" # if there's a leading zero, DO NOT omit it
...
gdb_name <- "" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "" # e.g., "main_merc233"
sample_layer <- "" # e.g., "main_mainSitesMerc233"
