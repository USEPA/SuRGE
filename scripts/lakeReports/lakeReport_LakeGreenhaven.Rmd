...
# identify lake
lake_id_i <- "317" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Lake Greenhaven"
...
gdb_name <- "lakeDsn/USGS/CH4-317/merc317.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc317" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc317" # e.g., "main_mainSitesMerc233"
