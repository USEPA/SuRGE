...
---
subtitle: "`r lake_name_i` Water Quality Summary"  
---
...
A field sensor is used to measure chlorophyll a, dissolved oxygen, pH, specific conductivity, water temperature, and turbidity near the water surface at 10 -20 locations within each reservoir.  Water samples are collected from the deepest site for analysis of nutrients and chlorophyll a.    

This summary presents water quality results for `r lake_name_i`. These data will be included in a formal peer-reviewed publication to be submitted for publication in 2024.  
...
Water temperature, dissolved oxygen, and pH were relatively constant through the reservoir surface waters.  Turbidity is highest in the eastern portion of the reservoir, which is where the main inflows enter.  It is possible that suspended sediment in the  river inflows contributed to turbidity in the eastern portion of the reservoir.
