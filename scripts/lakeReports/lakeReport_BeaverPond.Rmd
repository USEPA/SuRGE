...
# identify lake
lake_id_i <- "119" # if there's a leading zero, DO NOT omit it

lake_name_i <- "Beaver Pond"
...
gdb_name <- "lakeDsn/RTP/CH4-119/merc119.gdb" # e.g., "lakeDsn/CIN/CH4-233/merc233.gdb"
perim_layer <- "main_merc119" # e.g., "main_merc233"
sample_layer <- "main_mainSitesMerc119" # e.g., "main_mainSitesMerc233"
